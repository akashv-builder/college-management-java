...
img1=new ImageIcon("tech1.gif");
l1=new JLabel(img1);
l1.setBounds(0,0,350,350);


img2=new ImageIcon("tech2.gif");
l2=new JLabel(img2);
l2.setBounds(0,350,350,350);



img3=new ImageIcon("tech3.gif");
l3=new JLabel(img3);
l3.setBounds(0,700,350,350);


img4=new ImageIcon("tech4.gif");
l4=new JLabel(img4);
l4.setBounds(1560,0,360,350);

img5=new ImageIcon("tech5.gif");
l5=new JLabel(img5);
l5.setBounds(1560,270,360,400);


img6=new ImageIcon("tech6.gif");
l6=new JLabel(img6);
l6.setBounds(1560,602,360,450);



img7=new ImageIcon("tech7.jpg");
l7=new JLabel(img7);
l7.setBounds(205,500,1500,500);


img8=new ImageIcon("techhead.gif");
